/*
 * peacock-file-utils.c - Some misc. utility functions for PeacockFile.
 * 
...
/**
 * peacock_file_util_get_local_uri:
 * @title: 
 * 
 ...
 **/
static const gchar *
peacock_file_util_get_local_uri (const gchar *title)
{
	gchar *filename = NULL;
	GtkWidget *filesel;
	gint response;
...
/**
 * peacock_file_util_get_uri:
 * @title: 
 * 
 * Show a dialog to get a URI to open. If user clicks "Browse", 
 * peacock_file_util_get_local_uri is called.
 * 
 * Return Value: filename selected.
 **/
const gchar *
peacock_file_util_get_uri (const gchar *title)
{
	return peacock_file_util_get_local_uri (title);
}

/**
 * peacock_file_util_show_ui_error:
 * @err_msg: 
 * 
 * Display a simple error dialog.
 **/
void
peacock_file_util_show_ui_error (const gchar *err_msg)
{
	GtkWidget *dialog;
...
gint
peacock_file_util_save_unsaved_response (const gchar *uri)
{
	GtkWidget *dialog;
	gint response;
...
/**
 * peacock_file_util_glade_dialog_new:
 * @fname: 
 * @wname: 
 * 
 ...
 **/
GladeXML *
peacock_file_util_glade_dialog_new (const gchar *fname, const gchar *wname)
{
	GladeXML *gui;
